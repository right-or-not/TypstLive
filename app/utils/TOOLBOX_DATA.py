        ...
        "Operations": {
            ...
            "icon_code": """
                #grid(
                  ...
                  gutter: 10pt, 
                  align: center + horizon,
                  text(fill: black)[$times$], text(fill: rgb(35, 157, 173))[$div$],
                  text(fill: rgb(35, 157, 173))[$plus.minus$], text(fill: black)[$cdot$]
                )
            """
        },
        "Relations": {
...
items = {
    ...
    "Common": {
        ...
        "hbar": { "code": "hbar", "icon_code": "$hbar$" },
        "im": { "code": "im", "icon_code": "$im$" },
        "re": { "code": "re", "icon_code": "$re$" },
    ...
    "Fonts": {
        "bb_fn": { "code": "bb()", "icon_code": "$bb(R)$", "move": 1 },
        "cal_fn": { "code": "cal()", "icon_code": "$cal(F)$", "move": 1 },
        "frak_fn": { "code": "frak()", "icon_code": "$frak(A)$", "move": 1 },
        "scr_fn": { "code": "scr()", "icon_code": "$scr(S)$", "move": 1 },
        "sans_fn": { "code": "sans()", "icon_code": "$sans(X)$", "move": 1 },
        "mono_fn": { "code": "mono()", "icon_code": "$mono(M)$", "move": 1 },
        "bold_fn": { "code": "bold()", "icon_code": "$bold(B)$", "move": 1 },
        "italic_fn": { "code": "italic()", "icon_code": "$italic(I)$", "move": 1 },
    },
    ...
    "Operations": {
        ...
        "cdot": { "code": "cdot", "icon_code": "$cdot$" },
        "circ": { "code": "circ", "icon_code": "$circ$" },
    ...
    "Logic": {
        ...
        "nexists": { "code": "nexists", "icon_code": "$nexists$" },
    ...
    "Sets": {
        ...
        "notin": { "code": "notin", "icon_code": "$notin$" },
        "subset": { "code": "subset", "icon_code": "$subset$" },
        "subseteq": { "code": "subseteq", "icon_code": "$subseteq$" },
        "union": { "code": "union", "icon_code": "$union$" },
        "sect": { "code": "sect", "icon_code": "$sect$" },
    ...
    "Constructs": {
        ...
        "binom": { "code": "binom()", "icon_code": "$ binom(n, k) $", "move": 1, "desc": "Binomial" },
        "sqrt": { "code": "sqrt()", "icon_code": "$ sqrt(x) $", "move": 1, "desc": "Square Root" },
        "root": { "code": "root(n, x)", "icon_code": "$ root(n, x) $", "move": 1, "desc": "Root" },
        "mat": { "code": "mat(;,)", "icon_code": "$ mat(1,2;3,4) $", "move": 4, "desc": "Matrix" },
